...
include "header.php";
include "action.php";
$login = $_SESSION['login'] ? test_input($_SESSION['login']) : '';
        ...
        <div class="row align-items-center">
            <div class="col-lg-12 mx-auto text-center">
                <div class="intro-wrap">
                    <?php
if (!isset($_SESSION) || !check_admin($_SESSION['login'])) {
            ...
            <div class="container px-5">
                <div class="bg-light rounded-3 py-5 px-4 px-md-5">
                    <div class="text-center mb-5">
                        ...
                        <a href="index.php"><h2 class="fw-bolder">Перейти на головну</h2></a>
                    </div>
...
?></p>
                    ...
                    <div class="card-footer text-muted text-center">
                        <small>Станом на <?php date_default_timezone_set('Europe/Kyiv');
echo date('d.m.Y H:i');?></small>
                    </div>
                </div>
            </div>
        </div>
